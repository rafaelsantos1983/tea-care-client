      ...
      if (id) {
        try {
          const response = await fetch(
            `http://localhost:3002/api/therapeutic-activity/cares/patient/${id}`,
            {
              headers: {
  ...
  return (
    <div className="min-h-screen bg-blue-500">
      ...
      <div className="flex flex-col md:flex-row p-5 justify-center">
        {/* Gráficos */}
        <div className="flex-wrap grid grid-cols-1 sm:grid-cols-2 gap-5 w-full md:w-2/3 mr-0 md:mr-10">
        ...
        <div className="w-full md:w-1/3 flex flex-col gap-5 md:gap-0 justify-center items-center h-full mt-10 md:mt-0">
          <div className="bg-white w-full h-[350px] rounded-[30px] flex flex-col">
            <div className="bg-[#FFE01D] rounded-[30px] overflow-hidden h-[90px] flex items-center justify-center  w-full">
            ...
            <div className="h-full gap-5 flex items-center flex-col mt-10">
              ...
              <button
                ...
                className="text-lg w-1/2 h-[60px] bg-green-500 text-white font-semibold rounded-[30px] hover:bg-green-600 hover:transform hover:scale-105 transition-transform duration-300"
              >
          ...
          <div className="flex bg-white w-full  h-[350px] rounded-[30px] flex-col mt-10">
            ...
            <div className="h-full gap-5 flex items-center flex-col mt-10 overflow-auto">
              {atendimentoRegistrado ? (
                atendimentoRegistrado.map((atendimento) => {
                  const professionalName = atendimento.professional
                    ? atendimento.professional.name
                    : "Paciente Ausente";
                  const absentValue = atendimento.absent
                    ? atendimento.absent
                    : null;
